...
const DEFAULT_GLOW_COLOR = '154, 57, 242'; // RGB equivalent of HSL(270, 70%, 55%)
      ...
      <style>
        {`
          .bento-section {
            ...
            --white: hsl(0, 0%, 100%);
            --purple-primary: rgba(154, 57, 242, 1);
            --purple-glow: rgba(154, 57, 242, 0.2);
            --purple-border: rgba(154, 57, 242, 0.8);
          }
